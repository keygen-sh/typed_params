...
RSpec.describe TypedParams::Validations::Length do
  let(:validation) { TypedParams::Validations::Length.new(options) }
  let(:options)    { nil }
  ...
  context 'with maximum: option' do
    ...
    it 'should fail' do
      expect { validation.call('foobarbaz') }.to raise_error TypedParams::ValidationError
    end
  end
  ...
  context 'with is: option' do
    ...
    it 'should fail' do
      expect { validation.call('a'*7) }.to raise_error TypedParams::ValidationError
    end
  end
end